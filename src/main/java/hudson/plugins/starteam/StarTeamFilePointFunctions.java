...
public class StarTeamFilePointFunctions {
  ...
  public static Collection<java.io.File> convertToFileCollection(final Collection<File> collection) {
  ...
  public static Collection<StarTeamFilePoint> convertFilePointCollection(final Collection<File> collection) throws IOException {
  ...
  public static Collection<File> extractFileSubCollection(final Map<java.io.File, File> map, final Collection<java.io.File> collection) {
  ...
  public static Map<java.io.File,File> convertToFileMap(final Collection<File> collection) {
  ...
  public static void computeDifference(final Collection<StarTeamFilePoint> starteamFilePoint, final Collection<StarTeamFilePoint> historicFilePoint, StarTeamChangeSet changeSet) {
    final Map<java.io.File, StarTeamFilePoint> starteamFilePointMap = StarTeamFilePointFunctions.convertToFilePointMap(starteamFilePoint);
  ...
  public static Collection<StarTeamFilePoint> loadCollection(final java.io.File file) throws IOException {
    ...
    for (String str:stringCollection) {
      ...
      StarTeamFilePoint f = new StarTeamFilePoint();
